...
const documents: Documents = {
    ...
    "\n    query GET_PROJECT_NOTE($id: bigint!) {\n        projectNote_by_pk(id: $id) {\n            note\n        }\n    }\n": types.Get_Project_NoteDocument,
    "\n    mutation SET_PROJECT_NOTE($id: bigint!, $note: String!) {\n        update_projectNote_by_pk(pk_columns:{id:$id}, _set:{note: $note}) {\n            id\n        }\n    }\n": types.Set_Project_NoteDocument,
    "\n    query GET_REPORT($id: bigint!) {\n        report_by_pk(id: $id) {\n            extraFields\n        }\n        extraFieldSpec(where:{targetModel:{_eq:\"reporting.Report\"}}){\n            internalName, type\n        }\n    }\n": types.Get_ReportDocument,
    "\n    mutation SET_REPORT($id: bigint!, $extraFields:jsonb!) {\n        update_report_by_pk(pk_columns:{id:$id}, _set:{extraFields: $extraFields}) {\n            id\n        }\n    }\n": types.Set_ReportDocument,
