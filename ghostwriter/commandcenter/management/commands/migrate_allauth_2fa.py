# From https://docs.allauth.org/en/dev/mfa/django-allauth-2fa.html
import base64
...
class Command(BaseCommand):
    """
    Migrates TOTP and recovert codes from the django-allauth-2fa extension to the implementation built into django-allauth.

    This should be along with changing the django settings.
    """
